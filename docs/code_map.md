...
**Last Updated:** 2026-02-27 23:28 UTC  
...
**Functions:** `_build_price_series_by_symbol, _daterange, _load_snapshot, _parse_date, _run_id_from_export_time, _score_from_entry, _utc_now_iso, build_parser, export_dataset, main`

**Module Variables:** `DATASET_SCHEMA_VERSION, args, backtest_cfg, candle, config, config_root, current, dt, e2, end` _(+32 more)_
...
| `_load_snapshot` | — | `ValueError`, `load` |
| `_parse_date` | — | `fromisoformat` |
| `_run_id_from_export_time` | — | `strftime`, `strptime` |
| `_score_from_entry` | — | `ValueError`, `get` |
| `_utc_now_iso` | — | `now`, `strftime` |
| `build_parser` | — | `ArgumentParser`, `add_argument` |
| `export_dataset` | `_build_price_series_by_symbol`, `_daterange`, `_load_snapshot`, `_parse_date`, `_run_id_from_export_time`, `_score_from_entry`, `_utc_now_iso` | `FileNotFoundError`, `Path`, `ValueError`, `append`, `compute_global_top20`, `dumps`, `evaluate_e2_candidate`, `exists`, `get`, `isoformat`, `join`, `load_config`, `mkdir`, `sort`, `write` |
...
_Generated by GitHub Actions • 2026-02-27 23:28 UTC_
