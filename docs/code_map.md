...
**Last Updated:** 2026-03-08 11:51 UTC  
...
**Module Variables:** `allowed, allowed_classes, asof_dt, asof_iso, asof_ts_ms, breakout_results, btc_regime, cmc, cmc_data, cmc_listings` _(+62 more)_
...
**Functions:** `_expect_bool, _expect_number, _load_decision_config, _normalize_reason_list, _normalize_tradeability_reasons, _stable_reason_order, _to_optional_bool, _to_optional_float, _to_optional_str, apply_decision_layer`

**Module Variables:** `ALLOWED_TRADEABILITY, ENTER_TRADEABILITY, REASON_ORDER, btc_cfg, can_enter, can_wait, cfg, decision_cfg, enter_threshold, entry` _(+16 more)_
...
**Functions:** `__init__, _format_m_usd, _format_pct, _format_setup_entry, _sanitize_optional_metric, _with_rank, generate_json_report, generate_markdown_report, save_reports`

**Module Variables:** `analysis, breakout_immediate, breakout_retest, btc_checks, btc_regime, coin_name, components, excel_config, excel_gen, excel_path` _(+29 more)_
...
| `apply_decision_layer` | `_load_decision_config`, `_normalize_reason_list`, `_normalize_tradeability_reasons`, `_stable_reason_order`, `_to_optional_bool`, `_to_optional_float`, `_to_optional_str` | `append`, `extend`, `get`, `upper` |
...
| `scanner/pipeline/__init__.py` | 9 | 46 | 55 | 🔴 High |
...
| `scanner/pipeline/decision.py` | 10 | 17 | 27 | 🔴 High |
...
_Generated by GitHub Actions • 2026-03-08 11:51 UTC_
