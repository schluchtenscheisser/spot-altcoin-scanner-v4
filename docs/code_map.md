...
**Last Updated:** 2026-03-08 20:12 UTC  
...
**Functions:** `__init__, _build_run_manifest, _build_trade_candidates, _decision_sort_key, _finite_number_or_none, _format_m_usd, _format_markdown_summary, _format_nullable_bool, _format_nullable_float, _format_pct, _format_reason_list, _format_setup_entry, _format_trade_candidate_markdown, _sanitize_bool_or_none, _sanitize_directional_volume_preparation, _sanitize_float_or_none, _sanitize_optional_metric, _sanitize_reason_list, _validate_trade_candidates_for_markdown, _with_rank, generate_json_report, generate_markdown_report, save_reports`

**Module Variables:** `allowed_keys, analysis, asof_iso, asof_ts_ms, candidate, canonical_schema_version, coin_name, components, counts, data_freshness` _(+59 more)_
...
| `_build_trade_candidates` | `_sanitize_bool_or_none`, `_sanitize_directional_volume_preparation`, `_sanitize_float_or_none`, `_sanitize_reason_list` | `append`, `get`, `sort` |
...
|--------|----------------|----------------|-------|----------|
| `scanner/pipeline/output.py` | 23 | 65 | 88 | 🔴 High |
...
_Generated by GitHub Actions • 2026-03-08 20:12 UTC_
