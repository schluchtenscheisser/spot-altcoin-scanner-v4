...
**Last Updated:** 2026-03-08 15:54 UTC  
...
**Module Variables:** `allowed, allowed_classes, asof_dt, asof_iso, asof_ts_ms, breakout_results, btc_regime, cmc, cmc_data, cmc_listings` _(+65 more)_
...
**Functions:** `__init__, _create_global_sheet, _create_setup_sheet, _create_summary_sheet, _format_large_number, _sanitize_optional_metric, generate_excel_report`

**Module Variables:** `breakout_immediate, breakout_retest, btc_checks, btc_regime, cell, col_letter, comp_key, comp_value, components, excel_path` _(+14 more)_
...
**Functions:** `_nested_bool, _nested_mapping_value, build_config_hash, derive_feature_flags, read_canonical_schema_version, write_manifest_atomic`

**Module Variables:** `canonical_json, cursor, tmp_path, version`
...
**Functions:** `__init__, _build_run_manifest, _build_trade_candidates, _decision_sort_key, _format_m_usd, _format_markdown_summary, _format_nullable_bool, _format_nullable_float, _format_pct, _format_reason_list, _format_setup_entry, _format_trade_candidate_markdown, _sanitize_bool_or_none, _sanitize_float_or_none, _sanitize_optional_metric, _sanitize_reason_list, _validate_trade_candidates_for_markdown, _with_rank, generate_json_report, generate_markdown_report, save_reports`

**Module Variables:** `analysis, asof_iso, asof_ts_ms, candidate, canonical_schema_version, coin_name, components, counts, data_freshness, decision` _(+54 more)_
...
**Module Variables:** `alt_r3, alt_r7, anti, ask, base, base_score, bb_rank, bb_score, bf, bid` _(+60 more)_

**Imports:** `__future__, scanner.pipeline.scoring.decision_inputs, scanner.pipeline.scoring.trade_levels, typing`
...
**Module Variables:** `atr_1d, atr_4h, atr_pct, atr_value, base_low, breakout_dist_20, breakout_level_20, cfg, close, close_1d` _(+19 more)_
...
| `_create_global_sheet` | `_format_large_number`, `_sanitize_optional_metric` | `Alignment`, `Font`, `PatternFill`, `cell`, `create_sheet`, `get`, `join` |
| `_create_setup_sheet` | `_format_large_number`, `_sanitize_optional_metric` | `Alignment`, `Font`, `PatternFill`, `cell`, `create_sheet`, `get`, `get_column_letter`, `items`, `join`, `lower` |
...
| `derive_feature_flags` | `_nested_bool` | — |
...
|------------------|----------------|----------------|
| `__init__` | — | `Path`, `get`, `info`, `mkdir` |
| `_build_run_manifest` | — | `Path`, `build_config_hash`, `derive_feature_flags`, `get`, `read_canonical_schema_version`, `setdefault`, `strftime`, `utcnow` |
| `_build_trade_candidates` | `_sanitize_bool_or_none`, `_sanitize_float_or_none`, `_sanitize_reason_list` | `append`, `get`, `sort` |
...
| `score_symbol` | `_anti_chase_multiplier`, `_bb_score`, `_breakout_distance_score`, `_btc_multiplier`, `_calc_high_20d_excluding_current`, `_evaluate_execution_gate`, `_find_breakout_indices`, `_overextension_multiplier`, `_trend_score`, `_volume_score` | `append`, `get`, `standardize_entry_readiness` |
...
| `scanner/pipeline/scoring/breakout_trend_1_5d.py` | 13 | 22 | 35 | 🔴 High |
...
| `scanner/pipeline/manifest.py` | 2 | 15 | 17 | 🔴 High |
...
_Generated by GitHub Actions • 2026-03-08 15:54 UTC_
